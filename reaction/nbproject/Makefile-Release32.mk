...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release32.mk dist/Release32/GNU-Linux-x86/libreaction.a

dist/Release32/GNU-Linux-x86/libreaction.a: ${OBJECTFILES}
	${MKDIR} -p dist/Release32/GNU-Linux-x86
	${RM} dist/Release32/GNU-Linux-x86/libreaction.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libreaction.a ${OBJECTFILES} 
	$(RANLIB) dist/Release32/GNU-Linux-x86/libreaction.a
...
${OBJECTDIR}/src/reaction_transformation.o: src/reaction_transformation.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -I.. -I../common -I../tinyxml/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/reaction_transformation.o src/reaction_transformation.cpp
