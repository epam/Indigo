...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-ReleaseIntel64.mk dist/ReleaseIntel64/ICC-Linux-x86/libreaction.a

dist/ReleaseIntel64/ICC-Linux-x86/libreaction.a: ${OBJECTFILES}
	${MKDIR} -p dist/ReleaseIntel64/ICC-Linux-x86
	${RM} dist/ReleaseIntel64/ICC-Linux-x86/libreaction.a
	${AR} rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libreaction.a ${OBJECTFILES} 
	$(RANLIB) dist/ReleaseIntel64/ICC-Linux-x86/libreaction.a
