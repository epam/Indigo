...
${OBJECTDIR}/src/pg_am/pg_bingo_match.o: src/pg_am/pg_bingo_match.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/pg_am
	${RM} $@.d
	$(COMPILE.cc) -g -I../.. -I../../common -Isrc/pg_common -Isrc/pg_core -I../src/core-c -I../src -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/pg_am/pg_bingo_match.o src/pg_am/pg_bingo_match.cpp
