...
public:
   ...
   inline int begin() const {return nextSetBit(0);}
   inline int end() const {return -1;}
   inline int next(int idx) const {return nextSetBit(idx + 1);}
   ...
   bool isEmpty() const {return (*_lastWordPtr) == 0; };
