...
void BingoPgCommon::getSearchTypeString(int type, indigo::ArrayChar& result, bool molecule)
{
    result.clear();
    if (molecule)
    {
...
int BingoPgCommon::executeQuery(indigo::ArrayChar& query_str)
{
    int result = 0;
    BINGO_PG_TRY
    {
