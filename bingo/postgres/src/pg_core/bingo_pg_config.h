...
public:
    ...
    void serialize(std::string& config_data);
...
private:
    ...
    void _toString(int value, std::string&);

    indigo::RedBlackStringObjMap<std::string> _rawConfig;
    indigo::RedBlackStringObjMap<std::string> _stringParams;
