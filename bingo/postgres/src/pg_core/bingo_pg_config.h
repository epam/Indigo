...
public:
    ...
    void serialize(indigo::ArrayChar& config_data);
...
private:
    ...
    void _toString(int value, indigo::ArrayChar&);

    indigo::RedBlackStringObjMap<indigo::ArrayChar> _rawConfig;
    indigo::RedBlackStringObjMap<indigo::ArrayChar> _stringParams;
    ...
    public:
        TauParameter(){};
        ~TauParameter(){};
        indigo::ArrayChar beg;
        indigo::ArrayChar end;
