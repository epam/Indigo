...
public:
    ...
    void readCmfItem(int section_idx, int mol_idx, indigo::std::string& cmf_buf);
    void readXyzItem(int section_idx, int mol_idx, indigo::std::string& xyz_buf);
    ...
    void readDictionary(indigo::std::string& _dictionary);
