...
public:
    ...
    void readCmfItem(int section_idx, int mol_idx, std::string& cmf_buf);
    void readXyzItem(int section_idx, int mol_idx, std::string& xyz_buf);
    ...
    void readDictionary(std::string& _dictionary);
