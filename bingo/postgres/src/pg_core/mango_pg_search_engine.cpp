...
void MangoPgSearchEngine::_prepareExactQueryStrings(indigo::ArrayChar& what_clause_str, indigo::ArrayChar& from_clause_str,
                                                    indigo::ArrayChar& where_clause_str)
{
...
void MangoPgSearchEngine::_prepareExactTauStrings(indigo::ArrayChar& what_clause_str, indigo::ArrayChar& from_clause_str,
                                                  indigo::ArrayChar& where_clause_str)
{
    ArrayOutput what_clause(what_clause_str);
    ArrayOutput from_clause(from_clause_str);
...
{
    IndexScanDesc scan_desc = (IndexScanDesc)scan_desc_ptr;
    ArrayChar search_type;
    ArrayChar search_query;
    ArrayChar search_options;
...
{
    IndexScanDesc scan_desc = (IndexScanDesc)scan_desc_ptr;
    QS_DEF(ArrayChar, what_clause);
    QS_DEF(ArrayChar, from_clause);
    QS_DEF(ArrayChar, where_clause);
    QS_DEF(ArrayChar, search_type);
    ArrayChar search_query;
    ArrayChar search_options;
    int bingo_res;
...
void MangoPgSearchEngine::_prepareGrossSearch(PG_OBJECT scan_desc_ptr)
{
    ...
    QS_DEF(ArrayChar, gross_query);
    QS_DEF(ArrayChar, search_type);
    ArrayChar search_sigh;
    ArrayChar search_mol;
    int bingo_res;
...
void MangoPgSearchEngine::_prepareMassSearch(PG_OBJECT scan_desc_ptr)
{
    ...
    QS_DEF(ArrayChar, where_clause_str);
    ArrayOutput where_clause(where_clause_str);
...
void MangoPgSearchEngine::_getScanQueries(uintptr_t arg_datum, ArrayChar& str1_out, ArrayChar& str2_out)
{
    /*
     * Get query info
     */
...
void MangoPgSearchEngine::_getScanQueries(uintptr_t arg_datum, float& min_bound, float& max_bound, indigo::ArrayChar& str1_out, indigo::ArrayChar& str2_out)
{
    /*
     * Get query info
     */
