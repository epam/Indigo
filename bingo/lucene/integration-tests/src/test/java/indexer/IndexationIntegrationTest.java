 ...
 */
public class IndexationIntegrationTest extends BaseTest {
    private static final String COMPOSITION = "C6H6";
    private long MAX_AVERAGE = 15;

    static Logger logger = Logger.getLogger(IndexationIntegrationTest.class);
    ...
    public void indexChemul() throws Exception {
        ...
        indexSDFile(IndexationIntegrationTest.class.getClassLoader().getResource("all_chemul.sd").getFile());
    }

    //@Test
    public void indexPubchem10M() throws Exception {
        indexSmilesFile(IndexationIntegrationTest.class.getClassLoader().getResource("pubchem_slice_10000000.smiles").getFile());
    }
}
