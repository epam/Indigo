...
static OCINumber* _mangoSub(OracleEnv& env, MangoOracleContext& context, const ArrayChar& query_buf, const ArrayChar& target_buf, const char* params)
{
...
static OCINumber* _mangoExact(OracleEnv& env, MangoOracleContext& context, const ArrayChar& query_buf, const ArrayChar& target_buf, const char* params)
{
...
static OCINumber* _mangoSim(OracleEnv& env, MangoOracleContext& context, const ArrayChar& query_buf, const ArrayChar& target_buf, const char* params)
{
...
static OCINumber* _mangoCommon(OCIExtProcContext* ctx, int context_id, OCILobLocator* target_loc, short target_ind, OCILobLocator* query_loc, short query_ind,
                               ...
                               OCINumber* (*callback)(OracleEnv& env, MangoOracleContext& context, const ArrayChar& query_buf, const ArrayChar& target_buf,
                                                      const char* params))
{
...
static OCIString* _mangoGrossCalc(OracleEnv& env, MangoOracleContext& context, const ArrayChar& target_buf)
{
...
static OCINumber* _mangoGross(OracleEnv& env, MangoOracleContext& context, const ArrayChar& target_buf, const char* query)
{
...
static OCINumber* _mangoMass(OracleEnv& env, MangoOracleContext& context, const ArrayChar& target_buf, const char* type)
{
    double molmass = 0;
    TRY_READ_TARGET_MOL
    {
