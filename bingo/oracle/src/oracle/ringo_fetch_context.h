...
{
public:
    RingoFetchContext(int id, RingoOracleContext& context, const std::string& query_id);
    ...
    static RingoFetchContext& create(RingoOracleContext& context, const std::string& query_id);
    static RingoFetchContext& get(int id);
    static RingoFetchContext* findFresh(int context_id, const std::string& query_id);
