...
static void _ringoIndexStart(OracleEnv& env, RingoFetchContext& context, const char* oper, const ArrayChar& query_buf, OCINumber* p_strt, OCINumber* p_stop,
                             const char* params)
{
