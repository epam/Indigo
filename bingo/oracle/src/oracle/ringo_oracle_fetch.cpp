...
ORAEXT int oraRingoIndexStart (OCIExtProcContext *ctx,
               int context_id,
...
ORAEXT int oraRingoIndexFetch (OCIExtProcContext *ctx, int fetch_id,
                               int maxrows,
...
ORAEXT void oraRingoIndexClose (OCIExtProcContext *ctx, int fetch_id)
{
   ORABLOCK_BEGIN
   {
      OracleEnv env(ctx, logger);
...
ORAEXT OCINumber * oraRingoIndexSelectivity (OCIExtProcContext *ctx, int context_id,
               const char    *oper,      short oper_ind,
               OCILobLocator *query_loc, short query_ind,
               OCINumber     *p_strt,    short strt_ind,
               OCINumber     *p_stop,    short stop_ind,
...
ORAEXT void oraRingoIndexCost (OCIExtProcContext *ctx, int context_id,
