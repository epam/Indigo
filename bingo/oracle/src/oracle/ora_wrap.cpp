...
void OracleLOB::readAll(ArrayChar& arr, bool add_zero)
{
    int len = getLength();
...
void OracleLOB::write(int start, const ArrayChar& data)
{
...
bool OracleStatement::executeSingleString(ArrayChar& result, OracleEnv& env, const char* format, ...)
{
    OracleStatement statement(env);
    va_list args;
...
bool OracleStatement::executeSingleBlob(ArrayChar& result, OracleEnv& env, const char* format, ...)
{
    OracleStatement statement(env);
    va_list args;
...
bool OracleStatement::executeSingleClob(ArrayChar& result, OracleEnv& env, const char* format, ...)
{
    OracleStatement statement(env);
    va_list args;
