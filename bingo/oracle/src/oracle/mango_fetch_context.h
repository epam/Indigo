...
{
public:
    MangoFetchContext(int id, MangoOracleContext& context, const std::string& query_id);
    ...
    static MangoFetchContext& create(MangoOracleContext& context, const std::string& query_id);
    static MangoFetchContext& get(int id);
    static MangoFetchContext* findFresh(int context_id, const std::string& query_id);
