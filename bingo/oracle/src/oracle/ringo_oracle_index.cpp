...
bool _ringoRegisterReaction(OracleEnv& env, const char* rowid, const ArrayChar& reaction_buf, RingoOracleContext& context, RingoIndex& index,
                            BingoFingerprints& fingerprints)
{
    QS_DEF(ArrayChar, data);
