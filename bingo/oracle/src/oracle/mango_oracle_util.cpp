...
static OCIString* _mangoSMILES(OracleEnv& env, const ArrayChar& target_buf, const char* options, BingoOracleContext& context, bool canonical)
{
...
void _ICM(BingoOracleContext& context, OracleLOB& target_lob, int save_xyz, ArrayChar& icm)
{
