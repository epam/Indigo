...
MangoFetchContext::MangoFetchContext(int id_, MangoOracleContext& context, const ArrayChar& query_id)
...
MangoFetchContext& MangoFetchContext::create(MangoOracleContext& context, const ArrayChar& query_id)
{
    OsLocker locker(_instances_lock);
    TL_GET(PtrArray<MangoFetchContext>, _instances);
...
MangoFetchContext* MangoFetchContext::findFresh(int context_id, const ArrayChar& query_id)
{
    OsLocker locker(_instances_lock);
    TL_GET(PtrArray<MangoFetchContext>, _instances);
