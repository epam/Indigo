...
QUERIES_DATA = {
    ...
    "fingerprint": abspath(
        "data/molecules/fingerprint/import/queries/mols.sdf"
    ),
    "compactmolecule": abspath(
        "data/molecules/compactmolecule/import/queries/mols.sdf"
    ),
    ...
    "similarity": abspath(
        "data/molecules/similarity/import/queries/queries.sdf"
    ),
    "sgroups": abspath("data/molecules/sgroups/import/queries/out.sdf"),
    "smarts": abspath(
        "data/molecules/smarts/import/queries/PaDEL_substructure.sma"
    ),
    "markush": abspath("data/molecules/markush/import/queries/out.sdf"),
    "resonance": abspath(
        "data/molecules/resonance/import/queries/queries.sdf"
    ),
    "pseudoatoms": abspath(
        "data/molecules/pseudoatoms/import/queries/out.sdf"
    ),
    "bigtable": abspath("data/molecules/bigtable/import/queries/queries.smi"),
    "tautomers": abspath(
        "data/molecules/tautomers/import/queries/queries.sdf"
    ),
    "checkmolecule": abspath(
        "data/molecules/checkmolecule/import/queries/mols.sdf"
    ),
    "aam": abspath("data/reactions/aam/import/queries/rxns.rdf"),
    "checkreaction": abspath(
        "data/reactions/checkreaction/import/queries/rxns.rdf"
    ),
    "compactreaction": abspath(
        "data/reactions/compactreaction/import/queries/rxns.rdf"
    ),
    "rcml": abspath("data/reactions/rcml/import/queries/rxns.rdf"),
    "rexact": abspath(
        "data/reactions/rexact/import/queries/exact_queries.rdf"
    ),
    "rfingerprint": abspath(
        "data/reactions/rfingerprint/import/queries/rxns.rdf"
    ),
