...
class TestMass:
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("mass", "mass(molecular-weight)")
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("mass", "mass(most-abundant-mass)")
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("mass", "mass(monoisotopic-mass)")
    )
