...
class TestRfingerprint:
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("rfingerprint", "rfingerprint(full)")
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("rfingerprint", "rfingerprint(sim)")
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected", query_cases("rfingerprint", "rfingerprint(sub)")
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected",
        query_cases("rfingerprint", "rfingerprint(sub-res)"),
    )
    ...
    @pytest.mark.parametrize(
        "query_id, expected",
        query_cases("rfingerprint", "rfingerprint(" "sub-tau)"),
    )
