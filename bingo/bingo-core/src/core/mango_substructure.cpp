...
void MangoSubstructure::loadQuery(const ArrayChar& buf)
{
...
void MangoSubstructure::loadSMARTS(const ArrayChar& buf)
{
    BufferScanner scanner(buf);
...
void MangoSubstructure::loadTarget(const ArrayChar& molfile_buf)
{
...
void MangoSubstructure::getHighlightedTarget(ArrayChar& molfile_buf)
{
...
void MangoSubstructure::getHighlightedTarget_Smiles(ArrayChar& smiles_buf)
{
...
bool MangoSubstructure::matchBinary(const ArrayChar& target_buf, const ArrayChar* xyz_buf)
{
