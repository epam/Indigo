...
void RingoExact::loadQuery(const std::string& buf)
{
...
void RingoExact::loadTarget(const std::string& target_buf)
{
...
bool RingoExact::matchBinary(const std::string& target_buf)
{
    BufferScanner scanner(target_buf);
