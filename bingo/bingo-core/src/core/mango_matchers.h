...
public:
    ...
    bool matchBinary(const ArrayChar& target_buf, const ArrayChar* xyz_buf);
    ...
    void getHighlightedTarget(ArrayChar& molfile_buf);
    void getHighlightedTarget_Smiles(ArrayChar& smiles_buf);
...
public:
    ...
    float calc(const ArrayChar& target_buf);
