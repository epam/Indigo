...
void MangoTautomer::setParams(int conditions, bool force_hydrogens, bool ring_chain, bool substructure, bool strict)
{
    ...
    _params.strict = strict;
}

void MangoTautomer::setParameters(const char* conditions)
{
    TautomerMethod m = RSMARTS;
    MoleculeTautomerMatcher::parseConditions(conditions, _params.conditions, _params.force_hydrogens, _params.ring_chain, m, _params.strict);
}
...
bool MangoTautomer::matchLoadedTarget()
{
    ...
    matcher.setRules(_params.conditions, _params.force_hydrogens, _params.ring_chain, m, _params.strict);
