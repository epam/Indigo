...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release64.mk dist/Release64/GNU-Linux-x86/libtinyxml.a

dist/Release64/GNU-Linux-x86/libtinyxml.a: ${OBJECTFILES}
	${MKDIR} -p dist/Release64/GNU-Linux-x86
	${RM} dist/Release64/GNU-Linux-x86/libtinyxml.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtinyxml.a ${OBJECTFILES} 
	$(RANLIB) dist/Release64/GNU-Linux-x86/libtinyxml.a
