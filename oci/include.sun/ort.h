...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
oratext* OCITypeElemName(/*_ OCIEnv *env, OCIError *err, 
                           CONST OCITypeElem *elem, ub4 *n_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeAttrNext(/*_ OCIEnv *env, OCIError *err, 
                        OCITypeIter *iterator_ort, OCITypeElem **elem _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeMethodNext(/*_ OCIEnv *env, OCIError *err, 
                            OCITypeIter *iterator_ort, 
                          OCITypeMethod **mdo _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeVTInsert(/*_ OCIEnv *env, OCIError *err, 
                          CONST oratext *schema_name, ub4 s_n_length, 
                          CONST oratext *type_name, ub4 t_n_length, 
                          CONST oratext *user_version, ub4 u_v_length _*/);
#else /* ANSI C */
...
/* ** OBSOLETE ** */
#if !defined(__STDC__) && !defined(__cplusplus) /* K&R C - not ANSI C */
sword OCITypeVTSelect(/*_ OCIEnv *env, OCIError *err, 
                          CONST oratext *schema_name, ub4 s_n_length, 
                          CONST oratext *type_name, ub4 t_n_length, 
