...
%EXEC_JAR% cvf %distPath%\indigo.jar com/ggasoftware/indigo/*.class
...
copy ..\indigo-renderer\dist\Win\x86\shared\Release\indigo.dll com\ggasoftware\indigo\Win\x86\
copy ..\indigo-renderer\dist\Win\x64\shared\Release\indigo.dll com\ggasoftware\indigo\Win\x64\
