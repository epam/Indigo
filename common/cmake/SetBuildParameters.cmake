...
if(UNIX AND NOT APPLE)
	...
	if (DEFINED ENV{UNIVERSAL} OR UNIVERSAL_BUILD)
		set(CMAKE_C_CREATE_SHARED_LIBRARY   "python ${CMAKE_CURRENT_LIST_DIR}/linkhack.py | gcc | <LINK_FLAGS> | <OBJECTS> | <LINK_LIBRARIES> | <TARGET>")
		set(CMAKE_CXX_CREATE_SHARED_LIBRARY "python ${CMAKE_CURRENT_LIST_DIR}/linkhack.py | g++ | <LINK_FLAGS> | <OBJECTS> | <LINK_LIBRARIES> | <TARGET>")
	endif()
endif()
if(APPLE)
