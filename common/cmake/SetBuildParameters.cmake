...
if(UNIX)
	...
	elseif(SUBSYSTEM_NAME MATCHES "x64")
		set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m64 -include ${CMAKE_CURRENT_LIST_DIR}/../hacks/gcc_preinclude.h")
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m64 -include ${CMAKE_CURRENT_LIST_DIR}/../hacks/gcc_preinclude.h")
	endif()
endif()
if(APPLE)
