...
if(UNIX)
	if (SUBSYSTEM_NAME MATCHES "x86")
		...
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m32 -include ${Common_SOURCE_DIR}/hacks/gcc_preinclude.h")
	elseif(SUBSYSTEM_NAME MATCHES "x64")
		set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m64")
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m64 -include ${Common_SOURCE_DIR}/hacks/gcc_preinclude.h")
	endif()
endif()
if(APPLE)
