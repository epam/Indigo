...
public class MoleculesInputTable extends TitledBorderPanel {
    ...
    private void initComponents() {
        ...
        molecules_with_id_table = new com.epam.indigo.controls.MoleculeTableWithIdPanel();
        ...
        molecules_with_id_table.addTableCellMouseListener(new com.epam.indigo.controls.TableCellMouseListener() {
   ...
   private void molecules_with_id_tableCellMouseDoubleClick (com.epam.indigo.controls.TableCellMouseEvent evt)//GEN-FIRST:event_molecules_with_id_tableCellMouseDoubleClick
   ...
   private void molecules_with_id_tableCellShowPopupMenu (com.epam.indigo.controls.TableCellMouseEvent evt)//GEN-FIRST:event_molecules_with_id_tableCellShowPopupMenu
   {//GEN-HEADEREND:event_molecules_with_id_tableCellShowPopupMenu
    ...
    private com.epam.indigo.controls.MoleculeTableWithIdPanel molecules_with_id_table;
