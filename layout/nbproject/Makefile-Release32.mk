...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release32.mk dist/Release32/GNU-Linux-x86/liblayout.a

dist/Release32/GNU-Linux-x86/liblayout.a: ${OBJECTFILES}
	${MKDIR} -p dist/Release32/GNU-Linux-x86
	${RM} dist/Release32/GNU-Linux-x86/liblayout.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblayout.a ${OBJECTFILES} 
	$(RANLIB) dist/Release32/GNU-Linux-x86/liblayout.a
