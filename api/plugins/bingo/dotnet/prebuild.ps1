...
${result} = 0
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Linux/x64/libbingo.so"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Linux/x86/libbingo.so"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Mac/10.7/libbingo.dylib"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Win/x64/bingo.dll"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Win/x86/bingo.dll"))
