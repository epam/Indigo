...
${result} = 0
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Linux/x64/libindigo-renderer.so"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Linux/x86/libindigo-renderer.so"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Mac/10.7/libindigo-renderer.dylib"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Win/x64/indigo-renderer.dll"))
touchIfNotExists([IO.Path]::GetFullPath("${resourceFolder}/Win/x86/indigo-renderer.dll"))
