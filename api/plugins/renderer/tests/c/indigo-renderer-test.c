...
void usage(void)
{
    fprintf(stderr,
            "Indigo version: %s\n\n"
            "Usage:\n"
            "  indigo-depict infile.{mol,rxn,cml,smi,ket} outfile.{png,svg,pdf} [parameters]\n"
            ...
            "  indigo-depict infile.smi outfile.{mol,rxn,cml,ket} [parameters]\n"
            "  indigo-depict infile.smi outfile.{sdf,rdf,cml} [parameters]\n"
            "  indigo-depict - SMILES outfile.{png,svg,pdf} [parameters]\n"
            "  indigo-depict - SMILES outfile.{mol,rxn,cml,ket} [parameters]\n"
            "  indigo-depict - InChI outfile.{png,svg,pdf} [parameters]\n"
            "  indigo-depict - InChI outfile.{mol,rxn,cml,ket} [parameters]\n"
            "\nParameters:\n"
            "-w <number>\n"
