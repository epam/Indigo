...
IndigoDeconvolutionElem::IndigoDeconvolutionElem (Molecule& mol, PropertiesMap& props) :
IndigoObject(DECONVOLUTION_ELEM), idx(-1)
{
   mol_in.clone_KeepIndices(mol, 0);
...
IndigoObject(DECOMPOSITION_MATCH), deco(0), _completeScaffold(false){
}
...
void IndigoDeconvolution::DecompositionEnumerator::_addAllRsites(QueryMolecule& r_molecule,
        IndigoDecompositionMatch& deco_match,
        RedBlackMap<int, int>& r_sites) {
