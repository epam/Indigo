...
IONS = [
    ...
    "[NH4+]", "[Li+]", "[Na+]", "[K+]", "[Rb+]", "[Cs+]", "[Be+2]", "[Mg+2]",
    "[Ca+2]", "[Sr+2]", "[Ba+2]", "[Al+3]", "[Ga+3]", "[Ge+4]", "[Sn+2]",
    "[Sn+4]", "[Pb+2]", "[Pb+4]", "[Sb+3]", "[Bi+3]", "[Sc+3]", "[Y+3]",
    "[Ti+4]", "[Zr+4]", "[V+4]", "[V+5]", "[Nb+5]", "[Cr+2]", "[Cr+3]",
    "[Mo+2]", "[Mo+3]", "[Mo+4]", "[Mn+2]", "[Fe+2]", "[Fe+3]", "[Co+2]",
    "[Ni+2]", "[Ru+3]", "[Co+2]", "[Co+3]", "[Rh+3]", "[Ni+2]", "[Ni+3]",
    "[Pd+2]", "[Cu+2]", "[Ag+]", "[Zn+2]", "[Cd+2]",
    # hydracids anions
    "[F-]", "[Cl-]", "[Br-]", "[I-]", "[S-2]", "[C-]#N",
    # inorganic oxyacids
    "B(=O)[O-]", "B([O-])([O-])[O-]", "C(=O)([O-])[O-]", "[O-][Si](=O)[O-]",
    "[O-][Si]([O-])([O-])[O-]", "N(=O)[O-]", "[N+](=O)([O-])[O-]",
    "[O-]P(=O)=O", "[O-]P(=O)([O-])[O-]", "[O-][As](=O)=O",
    "[O-][As](=O)([O-])[O-]", "[O-]S(=O)[O-]", "[O-]S(=O)(=O)[O-]",
    "[O-][Se](=O)(=O)[O-]", "[O-][Te](=O)[O-]",
    "[O-][Te]([O-])([O-])([O-])([O-])[O-]", "[O-][Al]=O", "[O-][Sn](=O)[O-]",
    # TODO: add [Al(OH)4]-, [Sn(OH)6]2- ???
    "[O-][Cr](=O)(=O)[O-] ", "[O-][Cr](=O)(=O)O[Cr](=O)(=O)[O-]",
    "[O-][Mn](=O)(=O)=O", "[O-]Cl", "[O-]Cl=O", "[O-]Cl(=O)=O",
    "[O-]Cl(=O)(=O)=O", "[O-]Br", "[O-]Br=O", "[O-]Br(=O)=O",
    "[O-]Br(=O)(=O)=O", "[O-]I(=O)=O",
