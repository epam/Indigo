...
BingoPtr<MultibitTree::_MultibitNode> MultibitTree::_buildNode(ArrayInt& fit_fp_indices, const ArrayBool& is_parrent_mb, int level)
{
    ...
    QS_DEF(ArrayInt, left_fit);
    left_fit.clear();
    QS_DEF(ArrayInt, right_fit);
    right_fit.clear();
