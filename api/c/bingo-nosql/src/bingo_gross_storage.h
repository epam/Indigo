...
namespace bingo
{
    ...
    {
    public:
        GrossStorageShort(size_t gross_block_size);

        static MMFAddress create(MMFPtr<GrossStorageShort>& gross_ptr, size_t gross_block_size);

        static void load(MMFPtr<GrossStorageShort>& gross_ptr, MMFAddress offset);
    ...
    private:
        MMFMapping _hashes;
        ByteBufferStorageShort _gross_formulas;
