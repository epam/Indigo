...
public:
    ...
    typedef void (*get_optf_string_t)(std::string& value);
    ...
    void getOptionValueStr(const char* name, std::string& value);
    ...
    void getOptionType(const char* name, std::string& value);
