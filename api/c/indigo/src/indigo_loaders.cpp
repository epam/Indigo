...
std::string& IndigoRdfData::getRawData()
{
    return _data;
}
...
IndigoRdfMolecule::IndigoRdfMolecule(std::string& data, PropertiesMap& properties, int index, long long offset)
...
IndigoRdfReaction::IndigoRdfReaction(std::string& data, PropertiesMap& properties, int index, long long offset)
...
IndigoSmilesMolecule::IndigoSmilesMolecule(std::string& smiles, int index, long long offset) : IndigoRdfData(SMILES_MOLECULE, smiles, index, offset)
{
}
...
IndigoSmilesReaction::IndigoSmilesReaction(std::string& smiles, int index, long long offset) : IndigoRdfData(SMILES_REACTION, smiles, index, offset)
{
}
...
IndigoCmlMolecule::IndigoCmlMolecule(std::string& data, int index, long long offset) : IndigoRdfData(CML_MOLECULE, data, index, offset)
{
}
...
IndigoCmlReaction::IndigoCmlReaction(std::string& data, int index, long long offset) : IndigoRdfData(CML_REACTION, data, index, offset)
{
}
...
IndigoCdxMolecule::IndigoCdxMolecule(std::string& data, PropertiesMap& properties, int index, long long offset)
...
IndigoCdxReaction::IndigoCdxReaction(std::string& data, PropertiesMap& properties, int index, long long offset)
