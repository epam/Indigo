...
static void indigoGetMolfileSavingMode(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetFilenameEncoding(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetLayoutOrientation(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetEmbeddingUniqueness(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetAromaticityModel(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetPkaModel(std::string& value)
{
    Indigo& self = indigoGetInstance();
...
static void indigoGetStereoOption(std::string& option)
{
    Indigo& self = indigoGetInstance();
