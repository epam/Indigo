...
public:
    typedef std::map<std::string, Array<int>> MatchRGroupsMap;
...
private:
    ...
    int _createRgMap(IndigoDecompositionMatch& deco_match, int aut_idx, MatchRGroupsMap& match_rgroups, Array<int>* rg_map_buf, bool change_scaffold);
