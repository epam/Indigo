...
void _indigoParseTauCondition(const char* list_ptr, int& aromaticity, ArrayInt& label_list)
{
...
bool IndigoMoleculeSubstructureMatcher::findTautomerMatch(QueryMolecule& query, PtrArray<TautomerRule>& tautomer_rules, ArrayInt& mapping_out)
{
