...
wget http://scitouch.net/downloads/indigo-python-api-$1-windows.zip
wget http://scitouch.net/downloads/indigo-python-api-$1-linux.zip
wget http://scitouch.net/downloads/indigo-python-api-$1-osx.zip
