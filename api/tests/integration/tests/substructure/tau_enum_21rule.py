...
print(
    testEnumTautomersForMolecule(
        "O=C1N=C(N)NC2=C(N=CN2)1", "OC1N=C(N)NC2C(N=CN=2)=1"
    )
)
print(
    testEnumTautomersForMolecule(
        "OC1N=C(N)NC2C(N=CN=2)=1", "O=C1N=C(N)NC2=C(N=CN2)1"
    )
)
...
print(
    testEnumTautomersForMolecule(
        "C1C=CC=C2C(NC(C3NC4=C(C=CC=C4)N=3)=N2)=1",
        "C1C=CC=C2C(NC(=C3N=C4C(C=CC=C4)=N3)N2)=1",
    )
)
print(
    testEnumTautomersForMolecule(
...
print(
    testEnumTautomersForMolecule(
        "CNC1=CC=NC2N(N=CN=2)1", "CN=C1C=CN=C2N(NC=N2)1"
    )
)
print(
    testEnumTautomersForMolecule(
        "CN=C1C=CN=C2N(NC=N2)1", "CNC1=CC=NC2N(N=CN=2)1"
    )
)
...
print(
    testEnumTautomersForMolecule(
        "NC1C=CC(C=C2C=CC(=O)C=C2)=CC=1", "N=C1C=CC(=CC2C=CC(O)=CC=2)C=C1"
    )
)
print(
    testEnumTautomersForMolecule(
        "N=C1C=CC(=CC2C=CC(O)=CC=2)C=C1", "NC1C=CC(C=C2C=CC(=O)C=C2)=CC=1"
    )
)
