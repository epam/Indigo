...
mol_iter = indigo.iterateSDFile(
    joinPathPy("molecules/tautomers/targets.sdf", base_tau)
)
target_list = [mol for mol in mol_iter]
query_iter = indigo.iterateSDFile(
    joinPathPy("molecules/tautomers/queries.sdf", base_tau)
)
