...
for root, dirnames, filenames in os.walk(
    joinPathPy("molecules/molfile", __file__)
):
    filenames.sort()
    for filename in filenames:
        ...
        try:
            ...
            renderer.renderToFile(
                mol,
                joinPathPy(
                    os.path.join(out_dir, filename + "_t.svg"), __file__
                ),
            )
            ...
            renderer.renderToFile(
                mol,
                joinPathPy(
                    os.path.join(out_dir, filename + "_t.png"), __file__
                ),
            )
        ...
        try:
            ...
            renderer.renderToFile(
                mol,
                joinPathPy(
                    os.path.join(out_dir, filename + "_q.svg"), __file__
                ),
            )
            ...
            renderer.renderToFile(
                mol,
                joinPathPy(
                    os.path.join(out_dir, filename + "_q.png"), __file__
                ),
            )
