...
renderer.renderGridToFile(arr, None, 2, joinPath("out/cdxml/cdxml-test-properties.cdxml"))

fonts = [ "Symbol", "Arial", "Algerian"]
for f in fonts:
    indigo.setOption("render-cdxml-title-font", f)
    renderer.renderGridToFile(arr, None, 3, joinPath("out/cdxml/cdxml-test-font%s.cdxml" % (f)))
