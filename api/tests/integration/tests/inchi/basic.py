...
m = indigo.loadMoleculeFromFile(joinPath("molecules/racemic.mol"))
m.dearomatize()
inchi = indigo_inchi.getInchi(m)
aux = indigo_inchi.getAuxInfo()
print(inchi)
...
m = indigo.loadMoleculeFromFile(joinPath("molecules/unknown_stereo.mol"))
m.dearomatize()
inchi = indigo_inchi.getInchi(m)
aux = indigo_inchi.getAuxInfo()
print(inchi)
...
m = indigo.loadMoleculeFromFile(joinPath("molecules/Double.mol"))
m.dearomatize()
inchi = indigo_inchi.getInchi(m)
aux = indigo_inchi.getAuxInfo()
print(inchi)
...
m = indigo.loadMoleculeFromFile(joinPath("molecules/Single.mol"))
m.dearomatize()
inchi = indigo_inchi.getInchi(m)
aux = indigo_inchi.getAuxInfo()
print(inchi)
