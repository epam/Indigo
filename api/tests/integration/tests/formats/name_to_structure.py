...
def testMoleculeLoader():
    ...
    try:
        for name in names:
            ...
            print(
                "Name {0} opened with loadMolecule\n\tSMILES {1}".format(
                    name, mol.canonicalSmiles()
                )
            )
    except IndigoException as e:
        print(
...
def testRelaxedIUPAC():
    ...
    names = [
        ...
        "2,4,6-octatriyn",
        "octa-2,4,6-triyn",
        "1,3-octadiene-5,7-diyn",
        "octa-1,3-diene-5,7-diyn",
    ]
    namesToSmiles(names)
    print("DONE\n")
...
def testSkeletal():
    ...
    names = [
        ...
        "silapentane",
        "2-silapropane",
        "6-sila-2,4-octadiene-6-yn",
        "2,4,6,8-tetrasila-5-ethyl-decane",
        "6-sila-octa-2,4-diene-6-yn",
        "6-sila-2,4-octadiene-6-yn",
        "1,7-disila-3,5-dithia-2,4-octadiene",
        "2-silaprop-2-ene",
        "silapropyne",
        "2-silaprop-2-yne",
