...
print("Molecules:")
for mol, num in zip(indigo.iterateSDFile(joinPath("molecules/stereo_parity.sdf")), range(100000)):
    print("\n*** Molecule #%d ***" % (num + 1))
...
for f in fnames:
    for mol, num in zip(indigo.iterateSDFile(joinPath(f)), range(100000)):
