...
reaction = indigo.loadQueryReaction("[*]C([#17,#35,#53])=O.O[*]>>[*]C(O[*])=O |$_R1;;;;;_R2;_R1;;;_R2;$|")
monomers = [
    [indigo.loadMolecule("CC(Cl)=O"), indigo.loadMolecule("C1(CCCCC1)C(Cl)=O")],
    [indigo.loadMolecule("[C@@H]1(O)[C@@H](O)[C@H](O)[C@@H](O)[C@H](O)[C@H]1O")]
]
