...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/test.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/test-triple.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/test-allene.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/3D-stereo.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
indigo.setOption("standardize-stereo-from-coordinates", "true")
indigo.setOption("skip-3d-chirality", "true")
mol = indigo.loadMoleculeFromFile(joinPath("molecules/2D-stereo.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
indigo.setOption("skip-3d-chirality", "false")
...
indigo.setOption("skip-3d-chirality", "true")
mol = indigo.loadMoleculeFromFile(joinPath("molecules/cis-trans-stereo.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
indigo.setOption("skip-3d-chirality", "false")
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/ferrocene.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/h_bond.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/wrong_complex.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
...
mol = indigo.loadMoleculeFromFile(joinPath("molecules/wrong_h_bond.mol"))
print(mol.molfile())
mol.standardize()
print(mol.molfile())
