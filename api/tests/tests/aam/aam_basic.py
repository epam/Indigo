...
testAutomap("INGNORE CHARGES0", [ "CCCCC" ], [ "CC[C++]CC" ] , "discard")
testAutomap("INGNORE CHARGES1", [ "CCCCC" ], [ "CC[C++]CC" ] , "discard ignore_charges")
testAutomap("INGNORE ISOTOPE0", [ "CCCCC" ], [ "CC[8CH2]CC"], "discard" )
testAutomap("INGNORE ISOTOPE1", [ "CCCCC" ], [ "CC[8CH2]CC"], "discard ignore_isotopes" )
testAutomap("INGNORE VALENCE0", [ "CC[GeH2]CC" ], [ "CC[Ge]CC"], "discard" )
testAutomap("INGNORE VALENCE1", [ "CC[GeH2]CC" ], [ "CC[Ge]CC"], "discard ignore_valence" )
testAutomap("INGNORE RADICAL0", [ "CCCCC" ], [ "CC[CH]CC"], "discard" )
