...
testSingleResonanceMatch("O=[*-]([O-])([O-])", "B([O-])([O-])[O-]", True, False)
testSingleResonanceMatch("[*]~[B-]([*-])([*-])", "B([O-])([O-])[O-]", True, False)
testSingleResonanceMatch("N-C(~[O-])~C~C(~[O-])-C", "CC(=O)[CH-]C(N)=O", False, False)
testSingleResonanceMatch("[C+]-[O-]", "C=O", False, False)
testSingleResonanceMatch("CC(O)=CC(N)=O", "CC(=O)[CH-]C(N)=O", True, False)
testSingleResonanceMatch("[NH-]C=CC=[*][*]=[*][*]=[*]C=CC=O", "[O-]C=CC=CC=CC=CC=CC=N", True, False)
