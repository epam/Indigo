...
def testTimeout():
   ...
   m1 = indigo.loadMolecule("CC1CC2CCC3CC4=CC=C5CCCC6=C/C=C7/C8CCCC9CC%10CCCC%11CC%12=C(C(C%10%11)C89)C7=CC(C2=C3CC4=C56)=C1%12");
   m2 = indigo.loadMolecule("C1CC2CC3CCCC4C3C3C2C(C1)C1CCC2CC5CCC6CC7=CC=C8CCCC9=C%10C=C4C4=C%11C(C5=C6C(C7=C89)=C%10%11)=C2C1=C34");
   try:
      deco = indigo.extractCommonScaffold([m1, m2], "EXACT")
   except:
      print("stopped")
