...
def test_simple_load_save_load():
    ...
    for struct in structs:
        ...
        assert exact_check(m1, m2)


def test_complex_load_save_load():
...
def test_simple_cis_trans_load():
...
def test_all_features_mol_ket():
    m1 = indigo.loadMoleculeFromFile(joinPath("molecules/all_features_mol.mol"))
    m2 = indigo.loadMoleculeFromFile(joinPath("molecules/all_features_mol.ket.json"))
    exact_check(m1, m2)


if __name__ == '__main__':
    test_simple_cis_trans_load()
    test_all_features_mol_ket()
    test_simple_load_save_load()
    test_complex_load_save_load
