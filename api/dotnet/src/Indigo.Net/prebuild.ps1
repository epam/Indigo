...
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "darwin-aarch64/libindigo.dylib" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "darwin-aarch64/libindigo-inchi.dylib" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "darwin-aarch64/libindigo-renderer.dylib" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "darwin-aarch64/libbingo-nosql.dylib" -destLibRoot ${resourceFolder}
...
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "linux-aarch64/libindigo.so" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "linux-aarch64/libindigo-inchi.so" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "linux-aarch64/libindigo-renderer.so" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "linux-aarch64/libbingo-nosql.so" -destLibRoot ${resourceFolder}
...
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-i386/indigo.dll" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-i386/indigo-inchi.dll" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-i386/indigo-renderer.dll" -destLibRoot ${resourceFolder}
...
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-aarch64/bingo-nosql.dll" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-aarch64/msvcp140.dll" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-aarch64/vcruntime140.dll" -destLibRoot ${resourceFolder}
copyOrTouchIfNotExists -srcLibRoot ${distLibFolder} -libPath "windows-aarch64/vcruntime140_1.dll" -destLibRoot ${resourceFolder}
