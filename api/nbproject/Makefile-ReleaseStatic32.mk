...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-ReleaseStatic32.mk dist/ReleaseStatic32/GNU-Linux-x86/libindigo.a

dist/ReleaseStatic32/GNU-Linux-x86/libindigo.a: ${OBJECTFILES}
	${MKDIR} -p dist/ReleaseStatic32/GNU-Linux-x86
	${RM} dist/ReleaseStatic32/GNU-Linux-x86/libindigo.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libindigo.a ${OBJECTFILES} 
	$(RANLIB) dist/ReleaseStatic32/GNU-Linux-x86/libindigo.a
