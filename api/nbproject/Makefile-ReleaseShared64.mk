...
dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ../tinyxml/dist/Release64/GNU-Linux-x86/libtinyxml.a
...
${OBJECTDIR}/src/indigo_savers.o: src/indigo_savers.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -I. -Isrc -I.. -I../common -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/indigo_savers.o src/indigo_savers.cpp
