...
LDLIBSOPTIONS=../layout/dist/Release64/GNU-Linux-x86/liblayout.a ../reaction/dist/Release64/GNU-Linux-x86/libreaction.a ../molecule/dist/Release64/GNU-Linux-x86/libmolecule.a ../graph/dist/Release64/GNU-Linux-x86/libgraph.a -lz -lpthread

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-ReleaseShared64.mk dist/ReleaseShared64/GNU-Linux-x86/libindigo.so

dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ../layout/dist/Release64/GNU-Linux-x86/liblayout.a

dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ../reaction/dist/Release64/GNU-Linux-x86/libreaction.a

dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ../molecule/dist/Release64/GNU-Linux-x86/libmolecule.a

dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ../graph/dist/Release64/GNU-Linux-x86/libgraph.a

dist/ReleaseShared64/GNU-Linux-x86/libindigo.so: ${OBJECTFILES}
	${MKDIR} -p dist/ReleaseShared64/GNU-Linux-x86
...
${OBJECTDIR}/src/indigo_decomposition.o: src/indigo_decomposition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -I. -Isrc -I.. -I../common -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/indigo_decomposition.o src/indigo_decomposition.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/ReleaseShared64
	${RM} dist/ReleaseShared64/GNU-Linux-x86/libindigo.so
