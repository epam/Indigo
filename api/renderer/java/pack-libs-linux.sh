...
jar uf dist/indigo-renderer.jar com/ggasoftware/indigo/Linux/x86/libindigo-renderer.so 
jar uf dist/indigo-renderer.jar com/ggasoftware/indigo/Linux/x64/libindigo-renderer.so 
