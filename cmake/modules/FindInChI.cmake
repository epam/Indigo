...
if (InChI_FOUND AND NOT TARGET InChI::InChI)
    ...
    elseif(EXISTS "${InChI_INCLUDE_DIR}/inchi/inchi_api.h")
        target_include_directories(InChI::InChI INTERFACE ${InChI_INCLUDE_DIR}/inchi)
    else()
        message(FATAL "Could not find inchi_api.h")
    endif()
endif()
