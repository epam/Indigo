...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-ReleaseIntel32.mk dist/ReleaseIntel32/ICC-Linux-x86/libgraph.a

dist/ReleaseIntel32/ICC-Linux-x86/libgraph.a: ${OBJECTFILES}
	${MKDIR} -p dist/ReleaseIntel32/ICC-Linux-x86
	${RM} dist/ReleaseIntel32/ICC-Linux-x86/libgraph.a
	${AR} rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libgraph.a ${OBJECTFILES} 
	$(RANLIB) dist/ReleaseIntel32/ICC-Linux-x86/libgraph.a
