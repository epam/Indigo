...
void RenderContext::fontsGetTextExtents(cairo_t* cr, const char* text, float& dx, float& dy, float& rx, float& ry)
{
    std::lock_guard<std::mutex> _lock(_cairo_mutex);
...
void RenderContext::fontsGetTextExtents(const char* text, float& dx, float& dy, float& rx, float& ry)
{
    std::lock_guard<std::mutex> _lock(_cairo_mutex);
    cairo_text_extents_t te;
