...
AttachmentLayout::AttachmentLayout(const BiconnectedDecomposer& bc_decom, const PtrArray<MoleculeLayoutGraph>& bc_components, const ArrayInt& bc_tree,
...
AttachmentLayoutSimple::AttachmentLayoutSimple(const BiconnectedDecomposer& bc_decom, const PtrArray<MoleculeLayoutGraph>& bc_components,
                                               const ArrayInt& bc_tree, MoleculeLayoutGraph& graph, int src_vertex)
...
float AttachmentLayout::calculateEnergy()
{
    ...
    QS_DEF(ArrayInt, drawn_vertices);
