...
namespace indigo
{
    ...
    public:
        ...
        static bool collectAtomList(Atom& qa, ArrayInt& list, bool& notList);
        static int parseQueryAtom(QueryMolecule& qm, int aid, ArrayInt& list);
    ...
    protected:
        ...
        void _postMergeWithSubmolecule(BaseMolecule& bmol, const ArrayInt& vertices, const ArrayInt* edges, const ArrayInt& mapping,
                                               int skip_flags) override;
        void _removeAtoms(const ArrayInt& indices, const int* mapping) override;
        void _removeBonds(const ArrayInt& indices) override;
