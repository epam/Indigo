...
namespace indigo
{
    ...
    protected:
        ArrayInt _aromBondsArray;          // Bonds used in this connectivity group
        ArrayInt _heteroAtomsIndicesArray; // Heteroatoms indices
    ...
    public:
        ...
        {
            ArrayInt bonds;
            ArrayInt bondsInvMapping;
            ArrayInt vertices;
            ArrayInt verticesFilter;
            ArrayInt heteroAtoms;
            ArrayInt heteroAtomsInvMapping;
        };
    ...
    protected:
        ...
        CP_DECL;
        TL_CP_DECL(ArrayInt, _vertexAromaticGroupIndex);
        TL_CP_DECL(ArrayBool, _vertexIsAcceptDoubleEdge);
        TL_CP_DECL(ArrayBool, _vertexIsAcceptSingleEdge);
        TL_CP_DECL(ArrayInt, _vertexProcessed);

        TL_CP_DECL(ArrayInt, _groupVertices);
        TL_CP_DECL(ArrayInt, _groupEdges);
        TL_CP_DECL(ArrayInt, _groupHeteroAtoms);
    ...
    protected:
        ...
        TL_CP_DECL(ArrayInt, _submoleculeMapping);
    ...
    protected:
        ...
        TL_CP_DECL(ArrayInt, _verticesInGroup);
        TL_CP_DECL(Dbitset, _verticesAdded);
        TL_CP_DECL(ArrayInt, _edges2GroupMapping);
        TL_CP_DECL(ArrayInt, _edges2IndexInGroupMapping);
        TL_CP_DECL(Array<byte>, _correctEdgesArray);
        TL_CP_DECL(ArrayInt, _verticesFixCount);
    ...
    private:
        ...
        CP_DECL;
        TL_CP_DECL(ArrayInt, vertex_connectivity);
    };
