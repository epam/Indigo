...
namespace indigo
{
    ...
    public:
        ...
        int transformHELMtoSGroups(std::string& helm_class, std::string& name, std::string& code, std::string& natreplace, StringPool& r_names);
        ...
        void getTemplateAtomAttachmentPointId(int atom_idx, int order, std::string& apid);
        int getTemplateAtomAttachmentPointsCount(int atom_idx);
        int getTemplateAtomAttachmentPointById(int atom_idx, std::string& att_id);
        ...
        virtual void getAtomDescription(int idx, std::string& description) = 0;
        virtual void getBondDescription(int idx, std::string& description) = 0;
        ...
        void getAtomSymbol(int v, std::string& output);
    ...
    protected:
        ...
        void _flipTemplateAtomAttachmentPoint(int idx, int atom_from, std::string& ap_id, int atom_to);
