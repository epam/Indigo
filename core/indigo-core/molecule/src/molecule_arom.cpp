...
void AromatizerBase::_handleCycle(const ArrayInt& path)
{
    // Check Huckel's rule
...
bool AromatizerBase::_cb_handle_cycle(Graph& graph, const ArrayInt& vertices, const ArrayInt& edges, void* context)
{
    AromatizerBase* arom = (AromatizerBase*)context;
...
void MoleculeAromatizer::findAromaticAtoms(BaseMolecule& mol, ArrayInt* atoms, ArrayInt* bonds, const AromaticityOptions& options)
{
