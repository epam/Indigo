...
void MoleculeTautomerUtils::countHReplacements(BaseMolecule& m, ArrayInt& h_rep_count)
{
...
void MoleculeTautomerUtils::highlightChains(BaseMolecule& g1, BaseMolecule& g2, const ArrayInt& chains_2, const int* core_2)
{
    int i;
