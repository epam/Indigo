      ...
      _currentLayer(0), _currentRule(0)
{
    ...
    if (_use_deprecated_inchi)
    {
        ...
        QS_DEF(ArrayInt, canonical_mapping);
...
bool TautomerEnumerator::refine_proc(const Molecule& uncleaned_fragments, Molecule& product, ArrayInt& mapping, void* userdata)
{
    bool changed = true;
    while (changed)
    {
...
void TautomerEnumerator::product_proc(Molecule& product, ArrayInt& monomers_indices, ArrayInt& mapping, void* userdata)
{
