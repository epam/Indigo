...
void MoleculeStereocenters::buildFromBonds(const StereocentersOptions& options, int* sensible_bonds_out)
{
    ...
    const ArrayBool& bonds_ignore = haworth_finder.getBondsMask();
    const ArrayBool& atoms_ignore = haworth_finder.getAtomsMask();
...
void MoleculeStereocenters::getAbsAtoms(ArrayInt& indices)
{
    indices.clear();
...
void MoleculeStereocenters::_getGroups(int type, ArrayInt& numbers)
{
    numbers.clear();
...
void MoleculeStereocenters::_getGroup(int type, int number, ArrayInt& indices)
{
    indices.clear();
...
void MoleculeStereocenters::getOrGroups(ArrayInt& numbers)
{
    _getGroups(ATOM_OR, numbers);
}

void MoleculeStereocenters::getAndGroups(ArrayInt& numbers)
{
    _getGroups(ATOM_AND, numbers);
}

void MoleculeStereocenters::getOrGroup(int number, ArrayInt& indices)
{
    _getGroup(ATOM_OR, number, indices);
}

void MoleculeStereocenters::getAndGroup(int number, ArrayInt& indices)
{
...
void MoleculeStereocenters::removeAtoms(const ArrayInt& indices)
{
...
void MoleculeStereocenters::removeBonds(const ArrayInt& indices)
{
    for (int i = 0; i < indices.size(); i++)
    {
...
bool MoleculeStereocenters::isAutomorphism(BaseMolecule& mol, const ArrayInt& mapping, const Filter* filter)
{
