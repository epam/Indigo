...
ArrayBool* DearomatizationsGroups::getAcceptDoubleBonds(void)
{
...
void DearomatizationMatcher::GraphMatchingVerticesFixed::setVerticesAccept(ArrayBool* verticesAcceptDoubleBond)
{
