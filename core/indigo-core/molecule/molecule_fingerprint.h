...
namespace indigo
{
    ...
    public:
        ...
        void (*cb_fragment)(BaseMolecule& mol, const ArrayInt& vertices, const ArrayInt& edges, bool use_atoms, bool use_bonds, dword hash);
    ...
    protected:
        ...
        static int _maximalSubgraphCriteriaValue(Graph& graph, const ArrayInt& vertices, const ArrayInt& edges, void* context);

        void _handleSubgraph(Graph& graph, const ArrayInt& vertices, const ArrayInt& edges);

        dword _canonicalizeFragment(BaseMolecule& mol, const ArrayInt& vertices, const ArrayInt& edges, bool use_atoms, bool use_bonds,
                                    int* different_vertex_count);

        void _canonicalizeFragmentAndSetBits(BaseMolecule& mol, const ArrayInt& vertices, const ArrayInt& edges, bool use_atoms, bool use_bonds,
        ...
        void _calculateFragmentVertexDegree(BaseMolecule& mol, const ArrayInt& vertices, const ArrayInt& edges);
        int _calculateFragmentExternalConn(BaseMolecule& mol, const ArrayInt& vertices, const ArrayInt& edges);
        ...
        TL_CP_DECL(ArrayInt, _atom_codes);
        TL_CP_DECL(ArrayInt, _bond_codes);
        TL_CP_DECL(ArrayInt, _atom_codes_empty);
        TL_CP_DECL(ArrayInt, _bond_codes_empty);
        TL_CP_DECL(ArrayInt, _atom_hydrogens);
        TL_CP_DECL(ArrayInt, _atom_charges);
        TL_CP_DECL(ArrayInt, _vertex_connectivity);
        TL_CP_DECL(ArrayInt, _fragment_vertex_degree);
        TL_CP_DECL(ArrayInt, _bond_orders);
