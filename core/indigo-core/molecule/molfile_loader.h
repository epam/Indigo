...
#pragma warning(disable : 4251)
    ...
    protected:
        ...
        TL_CP_DECL(ArrayInt, _atom_types);
        TL_CP_DECL(ArrayInt, _hcount);
        TL_CP_DECL(ArrayInt, _sgroup_types);
        TL_CP_DECL(ArrayInt, _sgroup_mapping);
        ...
        void _readRGroupOccurrenceRanges(const char* str, ArrayInt& ranges);
