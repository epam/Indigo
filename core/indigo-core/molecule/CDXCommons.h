...
const std::unordered_map<uint16_t, std::pair<std::string, ECDXType>> KCDXPropToName = {
    ...
    {kCDXProp_ChemicalPropertyID, {"ChemProptID", ECDXType::CDXString}},
...
const std::unordered_map<std::string, std::pair<uint16_t, ECDXType>> KCDXNameToProp = {
    ...
    {"Center3D", {kCDXProp_3DMajorAxisEnd, ECDXType::CDXPoint3D}},
    ...
    {"HeadCenterSize", {kCDXProp_Arrowhead_CenterSize, ECDXType::CDXUINT16}},
    {"HeadWidth", {kCDXProp_Arrowhead_Width, ECDXType::CDXUINT16}},
    ...
    {"ChemProptID", {kCDXProp_ChemicalPropertyID, ECDXType::CDXString}},
    {"ChemProptPSA", {kCDXProp_ChemicalPropertyFragmentLabel, ECDXType::CDXString}},
