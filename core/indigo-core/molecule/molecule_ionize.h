...
namespace indigo
{
    ...
    public:
        DECL_ERROR;
        static void estimate_pKa(Molecule& mol, const IonizeOptions& options, ArrayInt& acid_sites, ArrayInt& basic_sites, Array<float>& acid_pkas,
        ...
        static bool getAtomLocalFeatureSet(BaseMolecule& mol, int idx, ArrayInt& fp);
    ...
    private:
        ...
        static void _estimate_pKa_Simple(Molecule& mol, const IonizeOptions& options, ArrayInt& acid_sites, ArrayInt& basic_sites, Array<float>& acid_pkas,
                                         Array<float>& basic_pkas);
    ...
    protected:
        static void _setCharges(Molecule& mol, float ph, float ph_toll, const IonizeOptions& options, ArrayInt& acid_sites, ArrayInt& basic_sites,
                                Array<float>& acid_pkas, Array<float>& basic_pkas);
    };
