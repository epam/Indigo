...
namespace indigo
{
    ...
    public:
        ...
        void saveMoleculeFragment(BaseMolecule& mol, const Vec2f& offset, float scale, int id, ArrayInt& nodes_ids);
        ...
        void addCustomElement(int id, ArrayChar& name, PropertiesMap& attrs);
        void startCurrentElement(int id, ArrayChar& name, PropertiesMap& attrs);
