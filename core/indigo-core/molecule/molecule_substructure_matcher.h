...
namespace indigo
{
    ...
    public:
        ...
        static void makeTransposition(BaseMolecule& mol, ArrayInt& transposition);
    ...
    protected:
        struct MarkushContext
        {
            ...
            TL_CP_DECL(ArrayInt, query_marking);
            TL_CP_DECL(ArrayInt, sites);
            int depth;
        };
        ...
        CP_DECL;
        TL_CP_DECL(ArrayInt, _3d_constrained_atoms);
        TL_CP_DECL(ArrayInt, _unfolded_target_h);
        TL_CP_DECL(ArrayInt, _used_target_h);
