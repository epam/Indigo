...
namespace indigo
{
    ...
    public:
        ...
        bool has_mapping;
        CP_DECL;
        TL_CP_DECL(ArrayInt, atom_mapping_to_restore);
        TL_CP_DECL(ArrayInt, inv_atom_mapping_to_restore);
        TL_CP_DECL(ArrayInt, bond_mapping_to_restore);
        TL_CP_DECL(ArrayInt, inv_bond_mapping_to_restore);
    ...
    protected:
        ...
        void _readUIntArray(ArrayInt& dest);
        ...
        TL_CP_DECL(ArrayInt, _sgroup_order);
        Molecule* _mol;
