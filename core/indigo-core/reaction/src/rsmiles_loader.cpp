...
void RSmilesLoader::_loadReaction()
{
    ...
    QS_DEF(ArrayInt, rcnt_aam);
    QS_DEF(ArrayInt, ctlt_aam);
    QS_DEF(ArrayInt, prod_aam);
    QS_DEF(ArrayInt, rcnt_aam_ignorable);
    QS_DEF(ArrayInt, prod_aam_ignorable);
    QS_DEF(ArrayChar, buf);
    ArrayInt* aams[] = {&rcnt_aam, &ctlt_aam, &prod_aam};
    ArrayInt* ignorable_aams[] = {&rcnt_aam_ignorable, 0, &prod_aam_ignorable};
    ...
    QS_DEF(ArrayInt, r_fragments);
    QS_DEF(ArrayInt, c_fragments);
    QS_DEF(ArrayInt, p_fragments);
    ArrayInt* fragments[] = {&r_fragments, &c_fragments, &p_fragments};
    ...
    QS_DEF(ArrayInt, hl_atoms);
    QS_DEF(ArrayInt, hl_bonds);
    ...
    QS_DEF(ArrayInt, aam);
    QS_DEF(ArrayInt, ignorable_aam);
    QS_DEF(ArrayInt, mapping);
    QS_DEF(ArrayInt, hl_atoms_frag);
    QS_DEF(ArrayInt, hl_bonds_frag);
