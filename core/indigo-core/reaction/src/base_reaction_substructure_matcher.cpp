...
bool BaseReactionSubstructureMatcher::find()
{
    ...
    while (1)
    {
        ...
        else if (command != _NO_WAY)
        {
            ...
            ArrayInt& core1 = _matchers.top()->_current_core_1;
            ArrayInt& core2 = _matchers.top()->_current_core_2;
...
int BaseReactionSubstructureMatcher::_Matcher::nextPair()
{
    ...
    if (_enumerator.get() == 0)
    {
        ...
        ArrayInt& prev_core_1 = _context._matchers[_context._matchers.size() - 2]->_current_core_1;
...
bool BaseReactionSubstructureMatcher::_Matcher::addPair(int mol1_idx, int mol2_idx, const ArrayInt& core1, const ArrayInt& core2, bool from_first_side)
{
