...
void SmartTableOutput::_updateColumnWidths(int index, ArrayInt& widths)
{
...
void SmartTableOutput::_printLineSmart(int index, const ArrayInt& widths)
{
    const ArrayChar& line = _lines[index];
    if (line.size() == 0)
        return;
