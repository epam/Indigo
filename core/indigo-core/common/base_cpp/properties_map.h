...
namespace indigo
{
    ...
    public:
        ...
        //   inline RedBlackStringObjMap< ArrayChar >& getProperties() {
        //      return _properties;
        //   }
        void copy(RedBlackStringObjMap<ArrayChar>& properties);
        void copy(PropertiesMap&);
        void insert(const char* key, const char* value);
        ArrayChar& insert(const char* key);

        const char* key(int);
        const char* value(int);
        ArrayChar& valueBuf(const char* key);
    ...
    private:
        ...
        RedBlackStringObjMap<ArrayChar> _properties;
        ObjArray<ArrayChar> _propertyNames;
    };
