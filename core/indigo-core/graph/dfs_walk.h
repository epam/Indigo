...
namespace indigo
{
    ...
    public:
        ...
        void calcMapping(ArrayInt& mapping) const;
        ...
        void getNeighborsClosing(int v_idx, ArrayInt& res);
    ...
    protected:
        ...
        TL_CP_DECL(ArrayInt, _root_vertices);
        TL_CP_DECL(Array<Edge>, _closures);
        TL_CP_DECL(ArrayInt, _class_dist_from_exit);
    };
} // namespace indigo
