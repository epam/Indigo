...
{
    ObjArray<ArrayInt> v_lists;
    ObjArray<ArrayInt> e_lists;
...
{
    ObjArray<ArrayInt> v_maps;
    ObjArray<ArrayInt> e_maps;
    ArrayInt v_list;
    ArrayInt e_list;
...
void ScaffoldDetection::GraphBasket::addToNextEmptySpot(Graph& graph, ArrayInt& v_list, ArrayInt& e_list)
{
