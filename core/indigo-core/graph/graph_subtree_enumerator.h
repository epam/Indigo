...
namespace indigo
{
    ...
    public:
        ...
        void (*callback)(Graph& graph, const ArrayInt& vertices, const ArrayInt& edges, void* context);
        ...
        int (*maximal_critera_value_callback)(Graph& graph, const ArrayInt& vertices, const ArrayInt& edges, void* context);
    ...
    protected:
        ...
        TL_CP_DECL(ArrayInt, _vertices); // array with subgraph vertices
        TL_CP_DECL(ArrayInt, _edges);    // array with subgraph edges

        TL_CP_DECL(ArrayInt, _v_processed); // from _graph to _subtree
