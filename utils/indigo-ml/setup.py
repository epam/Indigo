...
if sys.argv[1] == "bdist_wheel":
    for opt in sys.argv[2:]:
        if opt.startswith("--plat-name"):
            ...
            if PLATFORM_NAME.startswith("macosx_11_0_intel"):
    ...
    if not INDIGO_LIBS:
        raise ValueError(
            "Wrong --plat-name value! Should be one of: macosx_11_0_arm64, macosx_11_0_intel, manylinux1_x86_64, manylinux2014_aarch64, manylinux1_i686, win_amd64, win32"
        )
