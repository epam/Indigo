 ...
 * pointer to a #cairo_path_t returned by a cairo-wasm function. Any path
 * that is created manually (ie. outside of cairo-wasm) should be destroyed
 * manually as well.
 *
 * Since: 1.0
 **/
