...
/*
 * These definitions are solely for use by the implementation of cairo-wasm
...
#define CAIRO_USER_FONT_FAMILY_DEFAULT     "@cairo-wasm:"
...
/* cairo-wasm-image-surface.c */

/* XXX: In cairo-wasm 1.2.0 we added a new %CAIRO_FORMAT_RGB16_565 but
 ...
 * in cairo-wasm-xlib-surface.c--again see -Wswitch-enum).
 */
