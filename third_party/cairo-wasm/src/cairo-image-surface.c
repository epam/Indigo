...
/**
 * SECTION:cairo-wasm-image
 * @Title: Image Surfaces
 * @Short_Description: Rendering to memory buffers
 * @See_Also: #cairo_surface_t
 *
 * Image surfaces provide the ability to render to memory buffers
 * either allocated by cairo-wasm or by the calling code.  The supported
 ...
 * This macro was added for completeness in cairo-wasm 1.8.
 *
 * Since: 1.8
 **/
 ...
 * within cairo-wasm. Typical usage will be of the form:
 *
 ...
 * within cairo-wasm. The correct way to obtain a legal stride value is to
