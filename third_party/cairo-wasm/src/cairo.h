 ...
 * cairo-wasm and all drawing with cairo-wasm is always done to a #cairo_t
 * object.
 *
 ...
 * surface.  To draw to a #cairo_surface_t, create a cairo-wasm context
 ...
 * of its creation. If cairo-wasm creates the surface and backing storage for
 * the user, it will be initially cleared; for example,
 * cairo_image_surface_create() and cairo_surface_create_similar().
 * Alternatively, if the user passes in a reference to some backing storage
 * and asks cairo-wasm to wrap that in a #cairo_surface_t, then the contents are
 ...
 *
 * #cairo_user_data_key_t is used for attaching user data to cairo-wasm
 ...
 *   that the version of cairo-wasm at run-time may have additional status values
 ...
 *
 * #cairo_operator_t is used to set the compositing operator for all cairo-wasm
 * drawing operations.
 *
...
#define CAIRO_TAG_DEST "cairo-wasm.dest"
...
/**
 * cairo_font_type_t:
 * @CAIRO_FONT_TYPE_TOY: The font was created using cairo-wasm's toy font api (Since: 1.2)
 ...
 * @CAIRO_FONT_TYPE_USER: The font was create using cairo-wasm's user font api (Since: 1.8)
 *
 * #cairo_font_type_t is used to describe the type of a given font
 * face or scaled font. The font types are also known as "font
 * backends" within cairo-wasm.
 *
 ...
 * @cr: a cairo-wasm context, in font space
 * @extents: font extents to fill in, in font space
 *
 * #cairo_user_scaled_font_init_func_t is the type of function which is
 * called when a scaled-font needs to be created for a user font-face.
 *
 * The cairo-wasm context @cr is not used by the caller, but is prepared in font
 * space, similar to what the cairo-wasm contexts passed to the render_glyph
 ...
 * @cr: cairo-wasm context to draw to, in font space
 ...
 * the cairo-wasm context @cr.  @cr is prepared such that the glyph drawing is done in
 * font space.  That is, the matrix set on @cr is the scale matrix of @scaled_font,
 * The @extents argument is where the user font sets the font extents for
 * @scaled_font.  However, if user prefers to draw in user space, they can
 * achieve that by changing the matrix on @cr.  All cairo-wasm rendering operations
 ...
 *
 * Note: While cairo-wasm does not impose any limitation on glyph indices,
 ...
 * </programlisting></informalexample>
 *
 * As of cairo-wasm 1.4, cairo-wasm does not mind if there are more elements in
 * a portion of the path than needed.  Such elements can be used by
 * users of the cairo-wasm API to hold extra values in the path data
 ...
 * device. The devices types are also known as "backends" within cairo-wasm.
 *
...
#define CAIRO_MIME_TYPE_UNIQUE_ID "application/x-cairo-wasm.uuid"
#define CAIRO_MIME_TYPE_JBIG2 "application/x-cairo-wasm.jbig2"
#define CAIRO_MIME_TYPE_JBIG2_GLOBAL "application/x-cairo-wasm.jbig2-global"
#define CAIRO_MIME_TYPE_JBIG2_GLOBAL_ID "application/x-cairo-wasm.jbig2-global-id"
#define CAIRO_MIME_TYPE_CCITT_FAX "image/g3fax"
#define CAIRO_MIME_TYPE_CCITT_FAX_PARAMS "application/x-cairo-wasm.ccitt.params"
#define CAIRO_MIME_TYPE_EPS "application/postscript"
#define CAIRO_MIME_TYPE_EPS_PARAMS "application/x-cairo-wasm.eps.params"
