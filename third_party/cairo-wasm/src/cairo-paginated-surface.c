 ...
 * as possible for the various paginated surface backends in cairo-wasm
 * (PostScript, PDF, etc.). See cairo-wasm-paginated-private.h for
...
_cairo_paginated_surface_finish (void *abstract_surface)
{
	...
	/* Bypass some of the sanity checking in cairo-wasm-surface.c, as we
