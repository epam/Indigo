...
/**
 * SECTION:cairo-wasm-scaled-font
 ...
 *           +---------------+
 *
 *      In this case, the user of cairo-wasm API can set the device_space on
 ...
 *      negative (for systems similar to cairo-wasm, with origin at top left),
			 ...
			 const cairo_scaled_font_backend_t *backend)
{
	 ...
	 * again, that's what we do everywhere in cairo-wasm.
	 *
 ...
 * if the cairo-wasm graphics state were set to the same font_face,
 ...
 * glyphs, (as they would be drawn by cairo_show_glyphs() if the cairo-wasm
				...
				cairo_region_t		*clip_region)
{
     ...
     * they are implemented in terms of other operators in cairo-wasm-gstate.c
     */
 ...
 * created.  This object is owned by cairo-wasm. To keep a reference to it,
