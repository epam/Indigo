 ...
 * ---------------
 *
 * Users ask for things in user space. When cairo-wasm starts, a user space unit
 ...
 *
 * It is an affine matrix, like all cairo-wasm matrices, where its tx and ty
				...
				cairo_glyph_text_info_t    *info)
{
     ...
     * sizes.  I wanted to set the limit at 256.  But alas, seems like cairo-wasm's
     ...
     * fast rasterizer in cairo-wasm, we may want to readjust this.
     *
