/* cairo-wasm-output-stream.c: Output stream abstraction
 *
 ...
 * into cairo-wasm (see COPYING). -- Kristian Høgsberg <krh@redhat.com>
 */
static void
...
#define SINGLE_FMT_BUFFER_SIZE 32
	...
	/* The only format strings exist in the cairo-wasm implementation
