			       ...
			       const cairo_line_t *_right)
{
     ...
     * purposes, cairo-wasm will never generate such a crazy
     * trapezoid. Instead, cairo-wasm always uses for its points the
 ...
 * cairo-wasm region.  If so, the passed-in region is initialized to
