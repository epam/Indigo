 ...
 * SECTION:cairo-wasm
 * @Title: cairo_t
 * @Short_Description: The cairo-wasm drawing context
 * @See_Also: #cairo_surface_t
 *
 * #cairo_t is the main object used when drawing with cairo-wasm. To
 * draw with cairo-wasm, you create a #cairo_t, set the target surface,
 ...
 *
 * The functions with <emphasis>glyphs</emphasis> in their name form cairo-wasm's
 ...
 * cairo_show_text (cr, "This is a link to the cairo-wasm website.");
 * cairo_tag_end (cr, CAIRO_TAG_LINK);
 * </programlisting></informalexample>
 *
 * The PDF backend uses one or more rectangles to define the clickable
 * area of the link.  By default cairo-wasm will use the extents of the
 ...
 *
 * An example of the link attributes to the cairo-wasm website:
 * <programlisting>
 ...
 *
 * Note the PDF "Link" structure tag is the same as the cairo-wasm %CAIRO_TAG_LINK tag.
 *
 ...
 * user causes cairo-wasm to detect an error.
 **/
static void
 ...
 * as the source pattern in the given cairo-wasm context.
 *
 ...
 * cairo-wasm. To keep a reference to it, you must call
 ...
 *
 * Set the current fill rule within the cairo-wasm context. The fill rule
 ...
 * @width: a line width
 *
 * Sets the current line width within the cairo-wasm context. The line
 ...
 *
 * Sets the current line cap style within the cairo-wasm context. See
 ...
 *
 * Sets the current line join style within the cairo-wasm context. See
 ...
 *
 * Sets the current miter limit within the cairo-wasm context.
 *
 ...
 *
 * Note: As of cairo-wasm version 1.2.4 any call to cairo_close_path() will
 ...
 * cairo_stroke(), the current path will be cleared from the cairo-wasm
 ...
 * the cairo-wasm context. See cairo_set_fill_rule() and
 * cairo_fill_preserve().
 *
 * Since: 1.0
 **/
 ...
 * path within the cairo-wasm context.
 *
 ...
 *
 * After cairo_clip(), the current path will be cleared from the cairo-wasm
 * context.
 *
 ...
 *
 * See [Tags and Links Description][cairo-wasm-Tags-and-Links.description]
 ...
 * the cairo-wasm designers call the "toy" text API. It is convenient for
 ...
 * backends are compiled in, cairo-wasm will use an internal font family.
 ...
 * example, if you are using the freetype-based cairo-wasm-ft font backend,
 ...
 * pango), in conjunction with cairo-wasm.
 *
 ...
 *
 * Note: The cairo_show_text() function call is part of what the cairo-wasm
 * designers call the "toy" text API. It is convenient for short demos
 * and simple programs, but it is not expected to be adequate for
 * serious text-using applications. See cairo_show_glyphs() for the
 * "real" text display API in cairo-wasm.
 *
 * Since: 1.0
 **/
void
 ...
 *
 * Note: The cairo_text_path() function call is part of what the cairo-wasm
 * designers call the "toy" text API. It is convenient for short demos
 * and simple programs, but it is not expected to be adequate for
 * serious text-using applications. See cairo_glyph_path() for the
 * "real" text path API in cairo-wasm.
 *
 * Since: 1.0
 **/
void
 ...
 * @cr: a cairo-wasm context
 *
 * Gets the current compositing operator for a cairo-wasm context.
 *
 ...
 * @cr: a cairo-wasm context
 *
 * Gets the current compositing opacity for a cairo-wasm context.
 *
 ...
 * @cr: a cairo-wasm context
 *
 * Gets the target surface for the cairo-wasm context as passed to
 * cairo_create().
 *
 ...
 *
 * Return value: the target surface. This object is owned by cairo-wasm. To
