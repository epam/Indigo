 ...
 * follows. First, let's assume some cairo-wasm-using application code that is
 * successfully using the API/ABI "from" one version of cairo-wasm. Then let's
 * ask the question whether this same code can be moved "to" the API/ABI
 * of another version of cairo-wasm.
 *
 ...
 * </screen></informalexample>
 *
 * For example, checking that the cairo-wasm version is greater than or equal
 * to 1.0.0 could be achieved at compile-time or run-time as follows:
 *
 * <informalexample><programlisting>
 * ##if CAIRO_VERSION >= CAIRO_VERSION_ENCODE(1, 0, 0)
 * printf ("Compiling with suitable cairo-wasm version: %s\n", %CAIRO_VERSION_STRING);
 * ##endif
 *
 * if (cairo_version() >= CAIRO_VERSION_ENCODE(1, 0, 0))
 *     printf ("Running with suitable cairo-wasm version: %s\n", cairo_version_string ());
 ...
 * CAIRO_VERSION:
 *
 * The version of cairo-wasm available at compile-time, encoded using
 ...
 * CAIRO_VERSION_MAJOR:
 *
 * The major component of the version of cairo-wasm available at compile-time.
 *
 * Since: 1.0
 **/
 ...
 * CAIRO_VERSION_MINOR:
 *
 * The minor component of the version of cairo-wasm available at compile-time.
 *
 * Since: 1.0
 **/
 ...
 * CAIRO_VERSION_MICRO:
 *
 * The micro component of the version of cairo-wasm available at compile-time.
 *
 * Since: 1.0
 **/
 ...
 * CAIRO_VERSION_STRING:
 *
 * A human-readable string literal containing the version of cairo-wasm available
 ...
 *
 * This macro encodes the given cairo-wasm version into an integer.  The numbers
 ...
 * @micro: the micro component of the version number
 *
 * This macro encodes the given cairo-wasm version into an string.  The numbers
 ...
 * cairo_version:
 *
 * Returns the version of the cairo-wasm library encoded in a single
 * integer as per %CAIRO_VERSION_ENCODE. The encoding ensures that
 * later versions compare greater than earlier versions.
 *
 * A run-time comparison to check that cairo-wasm's version is greater than
 ...
 * cairo_version_string:
 *
 * Returns the version of the cairo-wasm library as a human-readable string
 * of the form "X.Y.Z".
 *
