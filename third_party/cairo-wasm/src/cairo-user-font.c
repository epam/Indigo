...
/**
 * SECTION:cairo-wasm-user-fonts
 * @Title:User Fonts
 * @Short_Description: Font support with font data provided by the user
 * 
 * The user-font feature allows the cairo-wasm user to provide drawings for glyphs
 ...
 * The user font backend is always built in versions of cairo-wasm that support
